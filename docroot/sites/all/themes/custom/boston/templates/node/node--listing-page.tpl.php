...
hide($content['links']);
?>
<?php if (!empty($with_image_title)): ?>
  <div class="title-wrapper">
    <div class="title-inner-wrapper">
      <h1 class="title-with-hero"><?php print $with_image_title; ?></h1>
    </div>
  </div>
<?php endif; ?>
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix desktop-100"<?php print $attributes; ?>>
  <?php if (isset($content['field_header_component'])): ?>
    <?php print render($content['field_header_component']); ?>
  <?php endif; ?>
