...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix desktop-100"<?php print $attributes; ?>>
  ...
  <div class="program-info-wrapper desktop-100">
    <div class="column mobile-100 desktop-66-left">
      ...
      <?php if (isset($content['field_additional_information'])): ?>
    ...
    <div class="column mobile-100 desktop-33-right">
      ...
      <?php endif; ?>
      <?php if (isset($content['field_single_neighborhood'])): ?>
        <div class="list-item">
      ...
      <?php endif; ?>
      <?php if (isset($content['field_did_you_know'])): ?>
        <div class="place-did-you-know">
          <h5>Did you know...</h5>
          <?php print render($content['field_did_you_know']); ?>
