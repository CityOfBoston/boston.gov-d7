...
<!-- 
Internal links don't currently have an associated icon.
If an icon is added, the code below will enable ribbon display.
<div class="ribbon link-icon-ribbon"></div>
 -->
