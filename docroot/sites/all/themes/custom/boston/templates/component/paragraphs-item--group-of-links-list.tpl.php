...
<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
  <div class="content container" <?php print $content_attributes; ?>>
    ...
    <div class="links-grid-left-rail mobile-100 <?php print (!$left_region_is_empty) ? "desktop-25-left" : "";?>">
    ...
    <div class="links-grid-field-list-links mobile-100 <?php print (!$left_region_is_empty) ? "desktop-75-right" : "desktop-100";?>">
      <?php print render($content['field_list_links']); ?>
    </div>
  </div>
</div>
