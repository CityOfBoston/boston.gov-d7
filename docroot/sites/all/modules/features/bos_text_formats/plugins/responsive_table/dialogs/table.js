...
( function() {
	...
	function tableDialog( editor, command ) {
		...
		return {
			...
			onShow: function() {
				...
				if ( command == 'tablePropertiesResponsive' ) {
          ...
          if (info.chkResponsive === true) {
            table.$.classList.add('responsive-table');
            if (info.selHeaders === 'row') {
              table.$.classList.add('responsive-table--horizontal');
              table.$.classList.remove('responsive-table--vertical');
            }
            else if (info.selHeaders === 'col') {
              table.$.classList.add('responsive-table--vertical');
              table.$.classList.remove('responsive-table--horizontal');
            }
            else {
              table.$.classList.remove('responsive-table--horizontal');
              table.$.classList.remove('responsive-table--vertical');
						...
						},
            {
              ...
              'default': true,
              setup: function( selectedTable ) {
                var classes = selectedTable.getAttribute('class');
                if (null === classes) {
                  this.setValue(false);
                }
                else {
                  this.setValue(classes.indexOf('responsive-table') > -1);
                }
              },
              commit: commitValue
            } ]
	...
	CKEDITOR.dialog.add( 'tablePropertiesResponsive', function( editor ) {
		return tableDialog( editor, 'tablePropertiesResponsive' );
	} );
} )();
