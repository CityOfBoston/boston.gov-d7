...
// Includes functions for protecting a site via ip, password, etc.
require_once DRUPAL_ROOT . '/sites/default/settings/permissions.settings.php';

// Include Incapsula API information.
if (isset($ah_site_directory) && file_exists($ah_site_directory . '/nobackup/incapsula.settings.php')) {
  require $ah_site_directory . '/nobackup/incapsula.settings.php';
}

// Includes settings for Acquia Search (via apachesolr).
// require DRUPAL_ROOT . '/sites/all/settings/search.settings.php';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_spyglass_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_spyglass_dd.inc';
}
// </DDSETTINGS>
...
if (!empty($_ENV['AH_SITE_ENVIRONMENT'])) {
  ...
  $conf['fast_404_HTML_error_page'] = './bos_404.html';
